...
namespace Ex03.GarageLogic
{
    ...
    public class Car : Vehicle
    {
        ...
        private readonly int MinAmountOfDoors = Conf.CarMinimumAmountDoors;
        private readonly int MaxAmountOfDoors = Conf.CarMaxAmountDoors;
        ...
        private int NumOfDoors
        {
            ...
            set
            {
                if (value< this.MinAmountOfDoors|| value> this.MaxAmountOfDoors)
                {
